export const personalInfo = {
  ...
  firstName: 'Meet',
  lastName: 'Chauhan',
  headline: 'Aspiring Software Engineer | Full Stack Developer | AI Enthusiast',
  location: 'Anand, Gujarat, India',
  email: 'meetaj369@gmail.com',
...
export const socialLinks = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/meetaj0369/', icon: 'Linkedin' },
  { name: 'GitHub', url: 'https://github.com/MeetAj369', icon: 'Github' },
  { name: 'Email', url: 'https://mail.google.com/mail/?view=cm&fs=1&to=meetaj369@gmail.com', icon: 'Mail' },
  { name: 'Phone', url: 'tel:+919106477426', icon: 'Phone' },
];

export const stats = [
  { label: 'Projects Built', value: 15, suffix: '+', icon: 'FolderGit2' },
  { label: 'Certificates Earned', value: 8, suffix: '+', icon: 'Award' },
  { label: 'Technologies', value: 15, suffix: '+', icon: 'Code2' },
  { label: 'Learning Hours', value: 500, suffix: '+', icon: 'Clock' },
  { label: 'Git Commits', value: 200, suffix: '+', icon: 'GitCommitHorizontal' },
  { label: 'Years Learning', value: 5, suffix: '+', icon: 'GraduationCap' },
];
